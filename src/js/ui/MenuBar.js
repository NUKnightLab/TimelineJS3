...
export class MenuBar {
    ...
    _initLayout() {
        ...
        this._el.button_search.innerHTML = "<span><i class='cas tl-icon-search toggle-search'></i></span>";
        this._el.button_search.setAttribute('aria-label', this._('search'));

        this._el.button_filter.innerHTML = "<span><i class='cas tl-icon-filter toggle-filter'></i></span>";
