/* Support Timeline Embed Generator web form (becomes timeline-embed-generator.js) */  
if(typeof generator_embed_path == 'undefined' || typeof generator_embed_path == 'undefined') {
	...
	var generator_embed_path = getScriptPath("timeline-embed-generator.js").split("js/")[0];
...
function getLinkAndIframe() {
	...
	if (e_source.value.match("docs.google.com")) {
		/// wut source_key = VMM.Timeline.DataObj.model.googlespreadsheet.extractSpreadsheetKey(e_source.value);
	} else {
		if (e_source.value == "") {
